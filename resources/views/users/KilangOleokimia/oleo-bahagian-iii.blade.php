                                                ...
                                                @foreach ($penyata as $data)
                                                    <tr style="text-align: right">
                                                        ...
                                                        <td>
                                                            <div class="icon" style="text-align: center">
                                                                <a href="#" type="button"
                                                                    data-bs-toggle="modal"  data-bs-target="#next2{{ $data->e104_c1 }}">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="modal fade" id="modal{{ $data->e104_c1 }}"
                                                        ...
                                                        <div class="modal fade" id="next2{{ $data->e104_c1 }}" tabindex="-1" role="dialog"
