                    ...
                    <form action="{{ route('oleo.update.maklumat.asas.pelesen', [$pelesen->e_id]) }}" method="post" onsubmit="return check()" novalidate>
                        ...
                        <div class="container center mt-5">
                            <div class="row justify-content-center" style="margin:20px 0px">
                                ...
                                <div class="col-md-7">
                                    <input type="text" id="e_ap1" class="form-control" maxlength="60" required oninput="this.setCustomValidity(''); invokeFunc(); valid_ap()"
                                    ...
                                    <div class="row justify-content-center" style="margin:20px 0px">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                            oninput="this.setCustomValidity(''); invokeFunc9(); valid_email()"
                                    ...
                                    <div class="row justify-content-center" style="margin:20px 0px">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            oninvalid="this.setCustomValidity('Sila isi ruangan ini')" oninput="this.setCustomValidity(''); invokeFunc10(); valid_npg()"
                                    ...
                                    <div class="row justify-content-center" style="margin:20px 0px">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            oninvalid="this.setCustomValidity('Sila isi ruangan ini')" oninput="this.setCustomValidity(''); invokeFunc11(); valid_jpg()"
                                    ...
                                    <div class="row justify-content-center" style="margin:20px 0px">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" id="e_notel_pg" class="form-control" maxlength="40"
                                                ...
                                                oninvalid="this.setCustomValidity('Sila isi ruangan ini')" oninput="this.setCustomValidity(''); invokeFunc12(); valid_notelpg()"
                                    ...
                                    <div class="row justify-content-center" style="margin:20px 0px">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            oninvalid="this.setCustomValidity('Sila isi ruangan ini')" oninput="this.setCustomValidity(''); invokeFunc13(); valid_emailpg"
