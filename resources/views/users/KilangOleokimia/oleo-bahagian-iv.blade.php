            ...
            <div class="mt-3 mb-4 row">
                <div class="col-md-12">
                    ...
                    <div class="card" style="margin-right:2%; margin-left:2%">
                        ...
                        <form action="{{ route('oleo.add.bahagian.iv') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="pl-3">
                                        <div class="mb-4 text-center">
                                            ...
                                            <h5 style="color: rgb(39, 80, 71)">Eksport Produk Oleokimia Dan Lain-Lain Produk Sawit</h5>
                                            {{-- <p>Maklumat Kilang</p> --}}
                                        </div>
                                        <hr>
                                        <div class="container center mt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name='e104_d7' style="width: 50%"
                                                        id="e104_d7" required
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name='e104_d5'
                                                        style="width:50%" id="e104_d5" required
                                                        title="Sila isikan butiran ini.">
                                                    {{-- @error('alamat_kilang_1')
                                                    <div class="alert alert-danger">
                                                        <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name='e104_d8' style="width: 50%"
                                                        id="e104_d8" required
                                                        title="Sila isikan butiran ini.">
                                                    {{-- @error('alamat_kilang_1')
                                                    <div class="alert alert-danger">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="date" class="form-control" name='e104_d6'
                                                        style="width:50%" id="e104_d6" required
                                                        title="Sila isikan butiran ini.">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-select" id="e104_d9"
                                                            style=" width:50%" name="e104_d9">
                                                            <option selected hidden disabled>Sila Pilih</option>
                                            ...
                                            <tbody>
                                                @foreach ($penyata as $data)
                                                        ...
                                                        <td>
                                                            <div class="icon" style="text-align: center">
                                                                <a href="#" type="button" data-bs-toggle="modal"
                                                                    data-bs-target="#modal{{ $data->e104_d1 }}">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="modal fade" id="modal{{ $data->e104_d1 }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form
                                                                            action="{{ route('oleo.edit.bahagian.iv', [$data->e104_d1]) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            <div class="modal-body">
                                                                                <label>Nama Produk </label>
                                                                                <div class="form-group">
                                                                                    <input type="text" name='e104_d4'
                                                                                        class="form-control"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" name='e104_d5'
                                                                                        class="form-control"
                                                                                        value="{{ $data->e104_d5 }}">
                                                                                </div>
                                                                                <label>Tarikh Eksport </label>
                                                                                <div class="form-group">
                                                                                    <input type="date" name='e104_d6'
                                                                                        class="form-control"
                                                                                        value="{{ $data->e104_d6 }}">
                                                                                </div>
                                                                                <label>Kuantiti (Tan Metrik) </label>
                                                                                <div class="form-group">
                                                                                    <input type="text" name='e104_d7'
                                                                                        class="form-control"
                                                                                        value="{{ $data->e104_d7 }}">
                                                                                </div>
                                                                                <label>Nilai </label>
                                                                                <div class="form-group">
                                                                                    <input type="text" name='e104_d8'
                                                                                        class="form-control"
                                                                                        value="{{ $data->e104_d8 }}">
                                                                                </div>
                                                                                ...
                                                                                <fieldset class="form-group">
                                                                                    <select class="form-select"
                                                                                        id="e104_c9" name="e104_d9">
                                                                                        <option
                                                                                            value="{{ $data->e104_d9 }}"
                                                                                            hidden>
                                                                                            {{ $data->negara->namanegara }}
                                                                                        </option>
                                                                                        @foreach ($negara as $data)
                                                                                            <option
                    ...
                    <div class="row form-group" style="padding-top: 10px; ">
                        ...
                        <div class="text-left col-md-5">
                            <a href="{{ route('oleo.bahagianiv') }}" class="btn btn-primary"
