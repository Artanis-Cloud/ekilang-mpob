    ...
    <div class="page-wrapper">
        ...
        <div class="card" style="margin-right:2%; margin-left:2%">
            ...
            <div class="card-body">
                ...
                <div class="">
                    <form action="{{ route('oleo.penyata.dahulu.process') }}" method="post" novalidate>
                        @csrf
                        ...
                        <div class="container center mt-2">
                            ...
                            <div class="row justify-content-center" >
                                ...
                                <div class="col-md-3">
                                    <fieldset class="form-group">
                                        <select class="form-control" id="bulan" name="bulan" required oninvalid="this.setCustomValidity('Sila buat pilihan dibahagian ini')"
                                        oninput="this.setCustomValidity(''); valid_bulan()">
