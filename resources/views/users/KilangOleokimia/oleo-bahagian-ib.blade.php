                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b5'
                                        ...
                                        style="width:50%" id="e104_b5" required title="Sila isikan butiran ini.">
                                    @error('e104_b5')
                                        <div class="alert alert-danger">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b10'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b10" required title="Sila isikan butiran ini.">
                                    @error('e104_b10')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b6'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b6" required title="Sila isikan butiran ini.">
                                    @error('e104_b6')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b11'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b11" required title="Sila isikan butiran ini.">
                                    @error('e104_b11')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b7'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b7" required title="Sila isikan butiran ini.">
                                    @error('e104_b7')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b12'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b12" required title="Sila isikan butiran ini.">
                                    @error('e104_b12')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b8'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b8" required title="Sila isikan butiran ini." readonly>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b13'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b13" required title="Sila isikan butiran ini.">
                                    @error('e104_b13')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name='e104_b9'
                                        oninput="validate_two_decimal(this)" onkeypress="return isNumberKey(event)"
                                        style="width:50%" id="e104_b9" required title="Sila isikan butiran ini.">
                                    @error('e104_b9')
                                        <div class="alert alert-danger">
                                            <strong>Sila isi butiran ini</strong>
                                        </div>
