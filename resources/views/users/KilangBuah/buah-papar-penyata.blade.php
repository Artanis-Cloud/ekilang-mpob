...
<body>
    ...
    <p><b>
            <font size="3" color="#0000FF">BAHAGIAN I : MAKLUMAT BELIAN, PROSES, PENGELUARAN, JUALAN/EDARAN, STOK AKHIR
    ...
    <table border="0" width="460" cellspacing="0" cellpadding="0">
        <tbody>
            ...
            <tr>
                <td width="380">
                    <font size="3">ii.&nbsp; Kadar Perahan MKSM (OER) yang diperolehi&nbsp;</font>
                </td>
                <td width="70">
                    <font size="3">: </font>
                </td>
    ...
    <table border="1" width="604" cellspacing="0" cellpadding="0" id="table1">
        ...
        <tbody>
            <tr>
                ...
                <td align="center" width="92">
                    <font size="3"><b>Tanda (<font face="Times New Roman">√)</font></b></font>
                </td>
            ...
            <tr>
                <td width="209">
                    <font size="3">e. Proses pengendalian bks yang minima (less ffb handling)</font>
                </td>
                <td width="92" align="center">
                    <font size="3">
                        &nbsp;</font>
    ...
    <p align="left">
        <font size="3" color="#0000FF"><b>BAHAGIAN III : BELIAN/PENERIMAAN BEKALAN BUAH KELAPA SAWIT (FFB) (52)</b>
        </font>
    </p>
    ...
    <p align="left">
        <font size="3" color="#0000FF"><b>BAHAGIAN V : EDARAN / JUALAN ISIRONG SAWIT (PK) DALAM NEGERI
                (51)</b></font>
    </p>
    ...
    <table border="1" width="342" bordercolor="#000000" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF"
        ...
        <tbody>
            ...
            <tr>
                <td width="168">&nbsp;&nbsp;&nbsp;&nbsp;<font size="2"><b>JUMLAH</b></font>
                </td>
                <td width="158" align="right">
                    <font size="3">
                        <b></b>
        ...
        <tbody>
            <tr>
                ...
                <td width="15%" align="center">
                    <font size="3"><b><b>Nombor Borang Kastam 2</b></b></font>
                </td>
