                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive col-10 ml-auto mr-auto" id="example1">
                                            ...
                                            <tbody style="word-break: break-word; font-size:12px">
                                                @foreach ($senarai_syarikat as $data)
                                                    <tr class="text-left">
                                                        ...
                                                        <td style="text-align: center">{{ $data->ebio_cc3 ?? '-' }}
                                                        </td>
                                                        <td style="text-align: center"><input type="text" size="10" name='ebio_cc4'
                                                                id='4bio_cc4' style="text-align: center; width:50%" required
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#next" style="float: right">
                                                Kemaskini
                                            </button>
