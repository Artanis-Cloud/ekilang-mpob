            ...
            <section class="section">
                ...
                <div class=" row form-group" style="padding-top: 10px; ">
                    ...
                    <div class="text-left col-md-5">
                        <a href="{{ route('bio.bahagianiii') }}" class="btn btn-primary" style="float: left">Sebelumnya</a>
                    </div>
                    <div class="text-right col-md-7">
                        <a href="{{ route('bio.bahagianv') }}" type="button" class="btn btn-primary "  style="float: right"
                            >Simpan &
                            Seterusnya</a>
                    </div>
