                ...
                <form method="get" action="" id="myfrm">
                    ...
                    <div class="pl-3">
                        ...
                        <body>
                            ...
                            <table border="0" width="80%" cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_ap2 ?? '' }}
                                            </b></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_as2 ?? '' }}
                                            </b></td>
                            ...
                            @if ($user->ebio_sdate == null)
                                <p>Tarikh Penghantaran:&nbsp;&nbsp;&nbsp; <b></b>
                                </p>
                            @else
                                <p>Tarikh
                                    Penghantaran:&nbsp;&nbsp;&nbsp;<b>{{ date('d-m-Y', strtotime($user->ebio_sdate)) }}
                                    </b></p>
                            @endif
                            ...
                            <p>No Telefon Kilang:&nbsp;&nbsp;<b><span style="text-transform:uppercase">{{ $user->ebio_notel ?? '' }}</span></b>
                            </p>
