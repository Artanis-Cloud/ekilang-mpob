                ...
                <form method="get" action="" id="myfrm">
                    ...
                    {{-- <div class="row"> --}}
                        <div class="" style="padding: 2%">
                            ...
                            <table border="0" width="111%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="88%" height="19" style="text-transform:uppercase">
                                            <b>{{ auth()->user()->name }}
                                            </b></td>
                            ...
                            <table border="0" width="80%" cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_ap1 }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_ap2 }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_ap3 }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_as1 }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_as2 }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_as3 }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_npg }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" style="text-transform:uppercase"><b>{{ $pelesen->e_jpg }}</b>
                                        </td>
                            ...
                            <p><b>
                                    <font color="#0c7c85">BAHAGIAN 5 (a) :&nbsp;&nbsp;&nbsp;&nbsp;BELIAN/TERIMAAN BEKALAN
                                        PRODUK SAWIT -
                                        SENDIRI</font>
                                </b></p>
                            <table border="1" width="100%" cellspacing="0" cellpadding="0"
                            ...
                            <p><b>
                                    <font color="#0c7c85">BAHAGIAN 5 (b) :&nbsp;&nbsp;&nbsp;&nbsp;BELIAN/TERIMAAN BEKALAN
                                        PRODUK SAWIT -
                                        LUAR</font>
                                </b></p>
                            <table border="1" width="100%" cellspacing="0" cellpadding="0"
                            ...
                            <form action="{{ route('penapis.update.papar.penyata', [$penyataiii->e101_reg]) }}"
                                ...
                                @csrf
                                @if ($pelesen2->e101_sdate == null)
                                    <p>Tarikh Penghantaran:&nbsp;&nbsp;&nbsp; <b></b>
                                    </p>
                                @else
                                    <p>Tarikh Penghantaran:&nbsp;&nbsp;&nbsp;
                                        <b>{{ date('d-m-Y', strtotime($pelesen2->e101_sdate)) }} </b></p>
                                @endif
                                <p>Nama Pegawai Melapor:&nbsp;&nbsp; <b><span
                                            style="text-transform:uppercase">{{ $penyataiii->e101_npg ?? '' }}</span></b>
                                </p>
                                <p>Jawatan Pegawai Melapor:&nbsp;&nbsp; <b><span
                                            style="text-transform:uppercase">{{ $penyataiii->e101_jpg ?? '' }}</span></b>
                                </p>
                                <p>No Telefon Kilang:&nbsp;&nbsp; <b><span
                                            style="text-transform:uppercase">{{ $penyataiii->e101_notel ?? '' }}</span></b>
                                </p>
                                </body>
