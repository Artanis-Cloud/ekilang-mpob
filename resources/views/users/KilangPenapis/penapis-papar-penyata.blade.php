                                ...
                                <p>
                                        ...
                                        <form action="{{ route('penapis.update.papar.penyata', [$penyataiii->e101_reg]) }}"
                                            ...
                                            <p>Nama Pegawai Melapor: &nbsp;&nbsp;
                                                <input type="text" id="e101_npg" class="form-control" size="50"
                                                    name='e101_npg' value="{{ $penyataiii->e101_npg }}">
                                            </p>
                                            <p>Jawatan Pegawai Melapor: &nbsp;&nbsp;
                                                <input type="text" id="e101_jpg" class="form-control" size="50"
                                                    name='e101_jpg' value="{{ $penyataiii->e101_jpg }}">
                                            </p>
                                            <p>No Telefon Kilang: &nbsp;&nbsp;

                                                <input type="text" id="e101_notel" class="form-control" size="50"
