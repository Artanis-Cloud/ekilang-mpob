                            ...
                            <div class="row">
                                ...
                                <div class="pl-3">
                                    ...
                                    <div class="mb-5 text-center">
                                        ...
                                        <h3 style="color: rgb(39, 80, 71); margin-bottom:3%">Bahagian V(a)</h3>
                                        <h5 style="color: rgb(39, 80, 71)">Belian/Penerimaan Bekalan Produk Sawit
                                            - <b>Luar</b></h5>
                                        {{-- <p>Maklumat Kilang</p> --}}
                                    </div>
                                    <hr>
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mb-0">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="text-bold-500"> Belian/Penerimaan Dari:</td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">CPKO</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">PPKO</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
