                            ...
                            <div class="card-body">
                                        ...
                                        <body>
                                            ...
                                            <p style="text-align: center; vertical-align:middle"><b>
                                                    ...
                                                    BULAN :&nbsp;&nbsp;
                                                    @if($users->e101_bln  == '01') JANUARI
                                                    @elseif($users->e101_bln  == '02') FEBRUARI
                                                    @elseif($users->e101_bln  == '03') MAC
                                                    @elseif($users->e101_bln  == '04') APRIL
                                                    @elseif($users->e101_bln  == '05') MEI
                                                    @elseif($users->e101_bln  == '06') JUN
                                                    @elseif($users->e101_bln  == '07') JULAI
                                                    @elseif($users->e101_bln  == '08') OGOS
                                                    @elseif($users->e101_bln  == '09') SEPTEMBER
