                            ...
                            <div class="row">
                                ...
                                <div class="pl-3">
                                    ...
                                    <div class="mb-5 text-center">
                                        ...
                                        <h3 style="color: rgb(39, 80, 71); margin-bottom:3%">Bahagian IV(a)</h3>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mb-0">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">Stok Awal</td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">Belian/Penerimaan</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">Pengeluaran</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">Jualan/Edaran Dalam Negeri</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">Eksport</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-bold-500">Stok Akhir</td>
                                                                        <td style="text-align:center;">
                                                                            <input type="text" class="calc"
                                                                                value="" size="15"
                                                                                onkeypress="return isNumberKey(event)">
