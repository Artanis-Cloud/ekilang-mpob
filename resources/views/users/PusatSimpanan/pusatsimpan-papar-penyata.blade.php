            ...
            <div class="card-body">
                <div class="pl-3">
                    ...
                    <body>
                        ...
                        <form action="{{ route('pusatsimpan.update.papar.penyata', [$user->e07_reg]) }}" method="post"
                            novalidate>
                            @csrf

                            <p>
                            <div class="required">Nama Pegawai Melapor:</div>
                            <input type="text" id="e_npg" class="form-control" size="50" maxlength="60"
                            ...
                            <input type="text" id="e_jpg" class="form-control" size="50" maxlength="60"
                                required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                            ...
                            <input type="text" id="e_notel" class="form-control" size="50" maxlength="50"
                                required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                            ...
                            <p type="hidden" id="err_notel" style="color: red; display:none"><i>Sila isi
                                    butiran di bahagian ini!</i></p>
                            <p type="hidden" id="err_notel2" style="color: red; display:none"><i>Sila masukkan nombor
                                    telefon yang betul!</i></p>
                            </p>
                            </p>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <span
                                                style="font-size: 16px; margin-bottom:0; text-align: justify; text-justify: inter-word"><b>
                                                    Saya mengaku bahawa maklumat yang diberikan sepanjang pengetahuan saya
                                                    adalah tepat,
                                                    benar, lengkap dan selaras dengan rekod harian.
                                                </b></span>
                                            <br>
