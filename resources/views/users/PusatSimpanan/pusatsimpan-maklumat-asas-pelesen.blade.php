        ...
        <div class="card" style="margin-right:3%; margin-left:3%">
            <div class="card-body">
                ...
                <div class="">
                    ...
                    {{-- @if ($pelesen) --}}
                    <form action="{{ route('pusatsimpan.update.maklumat.asas.pelesen') }}" method="post"  onsubmit="return check()" novalidate>
                        {{-- @else
                            ...
                            <div class="row justify-content-center" style="margin:20px 0px">
                                ...
                                <div class="col-md-7">
                                    <input type="text" id="e_nofax" class="form-control" placeholder="No. Faks"
                                        maxlength="40" name="e_nofax" value="{{ $pelesen->e_nofax ?? '' }}"
                                    ...
                                    <table style="width:100%; text-align: center; font-size: 10px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name='bil_tangki_ppo'
                                                    ...
                                                    id="bil_tangki_ppo" title="Sila isikan butiran ini."
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="text" class="form-control" name='kap_tangki_ppo'
                                                    onkeypress="return isNumberKey(event)" style="width:100%"
                                                    id="kap_tangki_ppo" onchange="validation_jumlah2()"
                                                    title="Sila isikan butiran ini." required
