                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        {{-- <div class="container" style="margin-top: 30%; margin-left:6%; ">
                            <h6 style="color: rgb(54, 51, 41)"><b>KILANG pusatsimpankimia</b></h6>
                        </div> --}}
                        </li>
                        <br>
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu " style="margin-left:-5%">
                                ...
                                <li>
                                    <a href="{{ route('pusatsimpan.tukarpassword') }}">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu " style="margin-left:-5%">
                                ...
                                <li>
                                    <a href="{{ route('pusatsimpan.bahagiana') }}">
                                        <i class="fas fa-seedling" style="color:rgb(54, 51, 41) "> </i>
                                        {{-- <i data-feather="file-text" width="20"></i> --}}
                                        <span style="color: rgb(0, 0, 0); ">Bahagian A</span>
                                    </a>
                                </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu " style="margin-left:-5%">
                                ...
                                <li>
                                    <a href="{{ route('pusatsimpan.prestasioer') }}">
                                ...
                                <li>
                                    <a href="{{ route('pusatsimpan.penyatadahulu') }}">
        ...
        <div id="main">
            ...
            <nav class="navbar navbar-header navbar-expand navbar-light">
                ...
                <span class="mx-2 mt-1 mb-1 text-center navbar-brand h1"
                    ...
                    style="font-family: Poppins, sans-serif; font-size:15px; margin-left:10%;">PUSAT SIMPANAN</b>
                </span>
                ...
                <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="row justify-content-center" style="margin-top: -5%">
                        <div class="col-xl-12 col-lg-8">
                            ...
                            <h1 style="font-size:20px; margin-left:10%;">PUSAT SIMPANAN</h1>
                            <h6 style=" margin-left:10%">Penyata Bulanan Pusat SImpanan</h6>
                        </div>
                    </div>
                                        ...
                                        <div class="pl-3">
                                            ...
                                            <ul>
                                                ...
                                                <li style="text-align: justify"> Penguatkuasaan Perintah Lembaga Minyak
                                                    ...
                                                    Pemegang Lesen Kategori Pusat Simpanan Kelapa Sawit (MF) dan Kilang
                                                    Pelumat Pusat Simpanan Sawit
