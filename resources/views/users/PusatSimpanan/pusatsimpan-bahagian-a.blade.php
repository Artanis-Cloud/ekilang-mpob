                            ...
                            <div class="row">
                                ...
                                <div class="pl-3">
                                    ...
                                    <div class="mb-4 text-center">
                                        ...
                                        <h5 style="color: rgb(39, 80, 71)">Instolasi Keluaran Minyak Sawit - Aktiviti Bukan Peralihan (Non Transhipment)
                                        </h5>
                                        {{-- <p>Maklumat Kilang</p> --}}
                                    </div>
                                    <hr>
                                    ...
                                    <div class="container center mt-4">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-2">
                                                <span class="required">Penerimaan Dalam Negeri:</span>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name='#'
                                                    style="width:50%" id="#" required
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-2">
                                                <span class="required">Edaran Dalam Negeri:</span>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name='#'
                                                    style="width:50%" id="#" required
                                ...
                                <br>
                                <br>
                                    <h5 style="color: rgb(39, 80, 71); text-align:center">Senarai Instolasi Keluaran Minyak Sawit - Aktiviti Bukan Peralihan (Non Transhipment)</h5>
