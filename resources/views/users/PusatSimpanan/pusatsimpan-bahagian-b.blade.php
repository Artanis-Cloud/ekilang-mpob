...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="card" style="margin-right:2%; margin-left:2%">
                ...
                <div class="card-body">
                    <div class="" style="padding: 2%">
                        <div class="mb-4 text-center">
                            <h3 style="color: rgb(39, 80, 71);margin-top:-2%  ">Bahagian B</h3>
                        ...
                        <div class="container center mt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mt-3">
                                    <span class="">Penerimaan Dari Luar Negara</span>
                                </div>
                                <div class="col-md-2 mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-3 mt-3">
                                    <span class=""> Edaran Ke Dalam Negeri/Import</span>
            ...
            <br>
            <br>
            <h5 style="color: rgb(39, 80, 71); text-align:center; margin-top:-3%; margin-bottom:3%">Senarai Instolasi Keluaran Minyak Sawit - Aktiviti Peralihan (Transhipment)</h5>
            ...
            <section class="section">
                ...
                <div class=" row form-group" style="padding-top: 10px; ">
                    ...
                    <div class="text-left col-md-5">
                        <a href="{{ route('pusatsimpan.bahagiana') }}" class="btn btn-primary" style="float: left">Sebelumnya</a>
                    </div>
                    <div class="text-right col-md-7">
                        <a href="{{ route('pusatsimpan.paparpenyata') }}" type="button" class="btn btn-primary "  style="float: right"
                            >Simpan &
                            Seterusnya</a>
                    </div>
