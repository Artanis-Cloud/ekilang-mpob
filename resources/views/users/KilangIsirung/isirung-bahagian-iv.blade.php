...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="card" style="margin-right:2%; margin-left:2%">
            ...
            <div class="card-body">
                <form action="{{ route('isirung.add.bahagian.iv') }}" method="post" class="sub-form" novalidate>
                    @csrf
                        ...
                        <div class="container center mt-3" >
                            <div class="row col-12 ml-auto mr-auto">
                                ...
                                <div class="col-md-2 mt-3">
                                    <select class="form-control" id="e102_b4" name="e102_b4" required oninvalid="this.setCustomValidity('Sila buat pilihan di bahagian ini')"
                                    oninput="this.setCustomValidity('');invokeFunc(); valid_sl()">
                            ...
                            {{-- <div class="row"> --}}
                                ...
                                <div class="col-md-2 mt-3">
                                    <input type="text" class="form-control" name='e102_b6' id="e102_b6"
                                        ...
                                        oninput="this.setCustomValidity(''); valid_kuantiti(); validateInput(event)" required onkeypress="return isNumberKey(event)"
                ...
                {{-- <br> --}}
                <br>
                <h5 style="color: rgb(39, 80, 71); text-align:center">Senarai Jualan/Edaran Minyak Isirung Sawit Mentah -
                    (CPKO) (04)</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0" style="font-size: 13px">
                                ...
                                <tbody>
                                    ...
                                    @endforeach
                                    <form action="{{ route('isirung.bahagianiv.process') }}" method="post">
                                        @csrf
                                        <tr>
