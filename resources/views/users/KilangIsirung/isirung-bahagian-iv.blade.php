                            ...
                            <div class="row">
                                    ...
                                    <div class="container center mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" style="margin-left:42%; width:40%">
                                                        <option selected hidden disabled>Kilang Penapis</option>

                                                            <option value="15">Kilang Penapis</option>
                                                            <option value="15">Kilang Isirung</option>
                                                            <option value="15">Kilang Oleokimia</option>
                                ...
                                <div class="row form-group" style="padding-top: 10px; ">
                                    ...
                                    <div class="text-left col-md-5">
                                        <a href="{{ route('isirung.bahagianiii') }}" class="btn btn-primary"
