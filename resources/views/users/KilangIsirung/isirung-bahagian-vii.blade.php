                ...
                <div class="card-body">
                    <div class="" style="padding: 2%">
                        <div class="mb-4 text-center">
                            <h3 style="color: rgb(39, 80, 71); margin-top:-2% ">Bahagian 7</h3>
            ...
            <section class="section">
                ...
                <div class=" row form-group" style="padding-top: 10px; ">
                    ...
                    <div class="text-left col-md-5">
                        <a href="{{ route('isirung.bahagianvi') }}" class="btn btn-primary" style="float: left">Sebelumnya</a>
                    </div>
                    <div class="text-right col-md-7">
                        <a href="{{ route('isirung.paparpenyata') }}" type="button" class="btn btn-primary "  style="float: right"
                            >Simpan &
                            Seterusnya</a>
                    </div>
