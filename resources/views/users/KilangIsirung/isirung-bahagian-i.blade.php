                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_aa1' id='e102_aa1' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="validate_two_decimal(this); this.setCustomValidity('');invokeFunc(); validateInput(event)"  onchange="autodecimal(this); FormatCurrency(this)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_aa3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc3(); validateInput(event)" id='e102_aa3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ab1' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc4(); validateInput(event)" id='e102_ab1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ab2' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc5(); validateInput(event)" id='e102_ab2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ab3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc6(); validateInput(event)" id='e102_ab3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ac1' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc7(); validateInput(event)" id='e102_ac1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ac2' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc8(); validateInput(event)" id='e102_ac2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ac3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc9(); validateInput(event)" id='e102_ac3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ae1' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc10(); validateInput(event)" id='e102_ae1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_af2' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc11(); validateInput(event)" id='e102_af2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_af3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc12(); validateInput(event)" id='e102_af3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ag1' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc13(); validateInput(event)" id='e102_ag1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ag2' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc14(); validateInput(event)" id='e102_ag2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ag3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc15(); validateInput(event)" id='e102_ag3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ah1' style="text-align: center" onClick="this.select();"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                                        oninput="this.setCustomValidity('');invokeFunc16(); validateInput(event)" id='e102_ah1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                        value="{{ number_format($penyata->e102_ah1 ?? 0, 2) }}">
                                                </td>
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ah2' style="text-align: center" onClick="this.select();"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                                        oninput="this.setCustomValidity('');invokeFunc17(); validateInput(event)" id='e102_ah2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ah3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc18(); validateInput(event)" id='e102_ah3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                <td class="text-bold-500 ">I.
                                                    Eksport</td>
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ai1' style="text-align: center" onClick="this.select();"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                                        oninput="this.setCustomValidity('');invokeFunc19(); validateInput(event)" id='e102_ai1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ai2' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc20(); validateInput(event)" id='e102_ai2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ai3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc21(); validateInput(event)" id='e102_ai3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_aj1' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc22(); validateInput(event)" id='e102_aj1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_aj2' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc23(); validateInput(event)" id='e102_aj2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_aj3' style="text-align: center"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')" onClick="this.select();"
                                                        oninput="this.setCustomValidity('');invokeFunc24(); validateInput(event)" id='e102_aj3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ak1' style="text-align: center" onClick="this.select();"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                                        oninput="this.setCustomValidity('');invokeFunc25(); validateInput(event)" id='e102_ak1'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                        value="{{ number_format($penyata->e102_ak1 ?? 0, 2) }}">
                                                </td>
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ak2' style="text-align: center" onClick="this.select();"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                                        oninput="this.setCustomValidity('');invokeFunc26(); validateInput(event)" id='e102_ak2'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
                                                        value="{{ number_format($penyata->e102_ak2 ?? 0, 2) }}">
                                                </td>
                                                <td style="text-align:center;">
                                                    <input type="text" size="10" name='e102_ak3' style="text-align: center" onClick="this.select();"
                                                        required oninvalid="this.setCustomValidity('Sila isi ruangan ini')"
                                                        oninput="this.setCustomValidity('');invokeFunc27(); validateInput(event)" id='e102_ak3'  onchange="autodecimal(this);FormatCurrency(this)"
                                                        onkeypress="return isNumberKey(event)"
