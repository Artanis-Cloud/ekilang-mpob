...
<body class=""style="background:url({{ asset('theme/images/background/Bio.jpg') }});background-size:cover;background-position:center;">
    <div class="container" id="container">
        ...
        <div class="overlay-container"
            style="background:url({{ asset('theme/images/background/pob2.jpg') }}); background-size:cover">
            <div class="overlay">
