...
<style>
    ...
    * {
    ...
    button {
        ...
        background-color: rgb(51, 123, 96);
        color: #FFFFFF;
        font-size: 12px;
        font-weight: bold;
        padding: 12px 45px;
...
<body class=""style="background:url({{ asset('theme/images/background/biji.png') }});background-size:cover;background-position:center;">
    <div class="container" id="container">
        ...
        <div class="overlay-container"
            style="background:  #35b296  ; background-size:cover">
            <div class="overlay">
                <div class="overlay-panel overlay-right">
                    ...
                    <span style="color:white">
                        ...
                        <div style="text-align: left">
                            <b>Penyata Bulanan Kilang Buah - MPOB (EL) MF4</b>
