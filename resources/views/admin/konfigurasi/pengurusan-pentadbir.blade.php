                                ...
                                <div class="container center">
                                    ...
                                    <div class="row" style="margin-top: -1% ">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="name" class="form-control" placeholder="Nama" required
                                                name="name" value="{{ old('name') }}" oninput="valid_name(); ValidateEmail()">
                                    ...
                                    <div class="row" style="margin-top: 1% ">
                                        <label for="fname"
                                            ...
                                            Emel</label>
                                        <div class="col-md-6">
                                            <input type="text" id="email" class="form-control" placeholder="Emel" required
                                                name="email" value="{{ old('email') }}" oninput="valid_email()">
                                    ...
                                    <div class="row" style="margin-top: 1% ">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="username" class="form-control" placeholder="Username" maxlength="8"
                                                name="username" value="{{ old('username') }}" oninput="valid_username()" required>
                                        ...
                                        <div class="col-md-6">
                                            @if (auth()->user()->role == 'Superadmin')
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="role" name="role" oninput="valid_role()" required
                                                        value={{ old('role') }}>
                                                    ...
                                                    <p type="hidden" id="err_role" style="color: red; display:none"><i>Sila buat pilihan di
                                                        bahagian ini!</i></p>
                                                </fieldset>
                                                @error('category')
                                                    <div class="alert alert-danger">
                                            ...
                                            @elseif (auth()->user()->role == 'Manager')
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="role2" name="role" oninput="valid_role2()"
                                                    ...
                                                    <p type="hidden" id="err_role2" style="color: red; display:none"><i>Sila buat pilihan di
                                                        bahagian ini!</i></p>
                                                </fieldset>
                                                @error('category')
                                                    <div class="alert alert-danger">
                                            ...
                                            @elseif (auth()->user()->role == 'Supervisor')
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="role3" name="role" oninput="valid_role3()"
                                                        value={{ old('role') }} required>
                                                        <option selected hidden disabled>Sila Pilih Kategori</option>
                                                        <option value="Admin">Admin</option>
                                                        <option value="Supervisor">Supervisor</option>
                                                    </select>
                                                    <p type="hidden" id="err_role3" style="color: red; display:none"><i>Sila buat pilihan di
                                                        bahagian ini!</i></p>
                                                </fieldset>
                                                @error('category')
                                                    <div class="alert alert-danger">
                                            ...
                                            @elseif (auth()->user()->role == 'Admin' || auth()->user()->role == '')
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="role" name="role" oninput="valid_role()"
                                                        value={{ old('role') }} required>
                                                        <option selected hidden disabled>Sila Pilih Kategori</option>
                                                        <option value="Admin">Admin</option>
                                                    </select>
                                    ...
                                    <div class="row" style="margin-top:1%">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="status" id="status" oninput="valid_status()" required>
                                                <option selected hidden disabled value="">Sila Pilih Status</option>
                                                <option value="1">Aktif</option>
                                                <option value="2">Tidak Aktif</option>
                                            </select>
                                            <p type="hidden" id="err_status" style="color: red; display:none"><i>Sila buat pilihan di
                                                bahagian ini!</i></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row center mt-3">
                                        <div class="col-md-12 center mb-3">
                                            <button type="button" class="btn btn-primary center" style="margin-left:45%" onclick="check()">Daftar</button>
