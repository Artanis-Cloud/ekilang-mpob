...
<head>
    ...
    <title>Menu Penyelenggaraan - Kilang Oleokimia</title>
    ...
    <link href="{{ asset('theme/kilangstyles/css/oleokimiastyle.css') }}"" rel=" stylesheet">
    <!-- =======================================================
                ...
                <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                    <div class="row justify-content-center" style="margin-bottom: 10%">
                        <div class="col-xl-12 col-lg-9">
                            ...
                            <h1 style="font-size:40px;">KILANG OLEOKIMIA</h1>
                            <h2>Penyata Bulanan Kilang Oleokimia</h2>
                        </div>
                    </div>
