        ...
        <div class="mt-3 mb-4 row">
                                            ...
                                            <table border="1" width="650" bordercolor="#000000" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{  number_format($penyata->e104_aa1 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="135">
                                                            <p style="text-align: center">
                                                                <font size="3">{{  number_format($penyata->e104_aa2 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="110">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_aa3 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_aa4 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ab1 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="135">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ab2 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="110">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ab3 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ab4 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ac1 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="135">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ad1 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="110">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ad2 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ad3 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ae1 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="135">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ae2 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="110">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ae3 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ae4 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ag1 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="135">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ag2 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="110">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ag3 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                        <td width="120">
                                                            <p align="center">
                                                                <font size="3">{{ number_format($penyata->e104_ag4 ?? 0,2) }}</font>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table border="0" width="460" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="70">
                                                            <font size="3">: {{ number_format($penyata->e104_ah1 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100">
                                                            <font size="3">: {{ number_format($penyata->e104_ah2 ?? 0,2) }}%</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="380">
                                                        ...
                                                        <td width="100">
                                                            <font size="3">: {{ number_format($penyata->e104_ah3 ?? 0,2) }}%</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="1000">
                                                        ...
                                                        <td width="150">
                                                            <font size="3">:&nbsp;RM {{ number_format($penyata->e104_ah4 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="380">
                                            ...
                                            <table border="1" width="604" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody style="border: 1px solid black;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah5 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah5 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;&nbsp;&nbsp;</font>
                                                            </td>
                                                        @endif
                                                        ...
                                                        @if ($penyata->e104_ah11 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah11 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah6 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah6 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                        ...
                                                        @if ($penyata->e104_ah12 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah12 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah7 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah7 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                        ...
                                                        @if ($penyata->e104_ah13 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah13 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah8 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah8 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                        ...
                                                        @if ($penyata->e104_ah14 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah14 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah9 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah9 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                        ...
                                                        @if ($penyata->e104_ah15 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah15 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah10 == 'Y')
                                                            <td width="92" align="center" rowspan="2">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah10 == null)
                                                            <td width="92" align="center" rowspan="2">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                        ...
                                                        @if ($penyata->e104_ah16 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah16 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($penyata->e104_ah17 == 'Y')
                                                            <td width="92" align="center">
                                                                <font size="3">&#10004; &nbsp;</font>
                                                            </td>
                                                        @elseif ($penyata->e104_ah17 == null)
                                                            <td width="92" align="center">
                                                                <font size="3"> &nbsp;</font>
                                                            </td>
                                                        @endif
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ai1 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ai ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ai3 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ai4 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ai5 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ai6 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">
                                                                <b>{{  number_format(($penyata->e104_ai1 ?? 0) +($penyata->e104_ai2 ?? 0)
                                                                +($penyata->e104_ai3 ?? 0) +($penyata->e104_ai4 ?? 0)
                                                                +($penyata->e104_ai5 ?? 0) +($penyata->e104_ai6 ?? 0) ?? 0,2) }}</b>
                                                            </font>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table border="1" width="342" bordercolor="#000000" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj1 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj2 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj3 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj4 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj5 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj6 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj7 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_aj8 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">
                                                                <b>{{  number_format(($penyata->e104_aj1 ?? 0) +($penyata->e104_aj2 ?? 0)
                                                                +($penyata->e104_aj3 ?? 0) +($penyata->e104_aj4 ?? 0)
                                                                +($penyata->e104_aj5 ?? 0) +($penyata->e104_aj6 ?? 0)
                                                                +($penyata->e104_aj7 ?? 0) +($penyata->e104_aj8 ?? 0) ?? 0,2) }}</b>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table border="1" width="342" bordercolor="#000000" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ak1 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ak2 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="168">
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">{{ number_format($penyata->e104_ak3 ?? 0,2) }}</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="158" align="center">
                                                            <font size="3">
                                                                <b>{{  number_format(($penyata->e104_ak1 ?? 0) + ($penyata->e104_ak2 ?? 0)
                                                                + ($penyata->e104_ak3 ?? 0) ?? 0,2) }}</b>
                                                            </font>
                                                        </td>
                                                    </tr>
                                                </tbody>
            ...
            <div class="row form-group" style="padding-top: 10px; margin-left: 2% ">
                ...
                <div class="text-left col-md-5">
                    <a href="{{ route('admin.9penyataterdahuluoleokimia') }}" class="btn btn-primary"
                    >Sebelumnya</a>
                </div>
