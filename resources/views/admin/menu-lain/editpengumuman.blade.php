                                        ...
                                        <div class="container center mt-2">
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset class="form-group">
                                                        <select class="form-select" id="basicSelect" name="Icon_new">
                                                            <option value="Y" {{ ( $pengumuman->Icon_new == 'Y') ? 'selected' : '' }}>Ya</option>
                                                            <option value="N" {{ ( $pengumuman->Icon_new == 'N') ? 'selected' : '' }}>Tidak</option>
                                                        </select>
                                                    </fieldset>
                                                    {{-- @error('alamat_kilang_1')
                                                    <div class="alert alert-danger">
                                            ...
                                            <div class="row" style="margin-bottom: 5%">
                                                <label for="fname"
                                                    ...
                                                    <input type="hidden" id="quill_html" name="Message" value="{{ old('Message') ?? $pengumuman->Message }}">
