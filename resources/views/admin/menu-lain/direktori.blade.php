                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="basicSelect" name="e_kat" required>
                                                        ...
                                                        @endif
                                                        @if ($cat == 'PL101')
                                                        <option value="PL91">KILANG PENAPIS</option>
                                                        @endif
                                                        @if ($cat == 'PL102')
                                                        <option value="PL91">KILANG ISIRUNG</option>
                                                        @endif
                                                        @if ($cat == 'PL104')
                                                        <option value="PL91">KILANG OLEOKIMIA</option>
                                                        @endif
                                                        @if ($cat == 'PL111')
                                                        <option value="PL91">PUSAT SIMPANAN</option>
                                                        @endif
                                                        @if ($cat == 'PLBIO')
