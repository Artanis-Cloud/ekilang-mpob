...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="padding: 20px; background-color: white; margin-right:2%; margin-left:2%">
                    ...
                    <div class="col-11 align-self-center" style="text-align: right">
                        <button type="button" class="btn btn-primary " style="margin: 1%" onclick="myPrint('myfrm'); updateStatus07({{ $e07_reg }})"
                                            ...
                                            <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    @if ($penyataii[$key] && !$penyataii[$key]->isEmpty())
                                                        @foreach ($penyataii[$key] as $dataii)
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <font size="2">{{ $dataii->produk->prodid }}</font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataii->e07t_stokawal ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataii->e07t_terima ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataii->e07t_edaran ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataii->e07t_eksport ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataii->e07t_pelarasan ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataii->e07t_stokakhir ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <font size="2">
                                                                <b>{{ number_format($totalii[$key] ?? 0, 2) }}</b></font>
                                                        </td>
                                                        <td align="right">
                                                            <font size="2">
                                                                <b>{{ number_format($totalii2[$key] ?? 0, 2) }}</b></font>
                                                        </td>
                                                        <td align="right">
                                                            <font size="2">
                                                                <b>{{ number_format($totalii3[$key] ?? 0, 2) }}</b></font>
                                                        </td>
                                                        <td align="right">
                                                            <font size="2"><b>{{ number_format($totalii7[$key] ?? 0, 2) }}</b></font>
                                                        </td>
                                                        <td align="right">
                                                            <font size="2">
                                                                <b>{{ number_format($totalii4[$key] ?? 0, 2) }}</b></font>
                                                        </td>
                                                        <td align="right">
                                                            <font size="2">
                                                                <b>{{ number_format($totalii5[$key] ?? 0, 2) }}</b></font>
                                                        </td>
    ...
    <script>
        function updateStatus07(e07_reg) {
            var token = "{{ csrf_token() }}";

            $.ajax({
                type: 'POST',
                url: '{{ route('update-status-07') }}', // Make sure this route exists in your web.php
                data: {
                    "_token": token,
                    "e07_reg": e07_reg
                },
