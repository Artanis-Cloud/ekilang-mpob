...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="row" style="padding: 20px; background-color: white; margin-right:2%; margin-left:2%">
                    ...
                    <div class="col-11 align-self-center" style="text-align: right">
                        <button type="button" class="btn btn-primary " style="margin: 1%" onclick="myPrint('myfrm'); updateStatus101({{ $e101_reg }})"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($penyatai[$key] as $datai)
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                <font size="2"> {{ number_format($datai->e101_b8 ?? 0, 2) }}</font>
                                                            </td>
                                                            <td align="right">
                                                                <font size="2">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($penyataii[$key] as $dataii)
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                <font size="2">{{ number_format($dataii->e101_b8 ?? 0, 2) }}</font>
                                                            </td>
                                                            <td align="right">
                                                                <font size="2">
    ...
    <script>
        function updateStatus101(e101_reg) {
            var token = "{{ csrf_token() }}";

            $.ajax({
                type: 'POST',
                url: '{{ route('update-status-101') }}', // Make sure this route exists in your web.php
                data: {
                    "_token": token,
                    "e101_reg": e101_reg
                },
