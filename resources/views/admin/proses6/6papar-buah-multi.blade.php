        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-5 align-self-center">
                    <h4 class="page-title">Penyata Terkini</h4>
                </div>
                                    ...
                                    <table border="0" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="88%" height="19"><b>{{ $data->e_nl }}
                                                    </b></td>
                                    ...
                                    <table border="1" width="650" bordercolor="#000000" cellspacing="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_aa1 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="135">
                                                    <p style="text-align: center">
                                                        <font size="3">{{ number_format($penyata->e91_aa2 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="110">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_aa3 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_aa4 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ab1 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="135">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ab2 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="110">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ab3 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ab4 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ac1 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="135">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ad1 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="110">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ad2 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ad3 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ae1 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="135">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ae2 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="110">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ae3 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ae4 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ag1 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="135">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ag2 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="110">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ag3 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                                <td width="120">
                                                    <p align="center">
                                                        <font size="3">{{ number_format($penyata->e91_ag4 ?? 0, 2) }}
                                                        </font>
                                                    </p>
                                                </td>
                                            </tr>
                                    ...
                                    <table border="0" width="460" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="100">
                                                    <font size="3">: {{ number_format($penyata->e91_ah2 ?? 0, 2) }}%
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="100">
                                                    <font size="3">: {{ number_format($penyata->e91_ah3 ?? 0, 2) }}%
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19"><b>
                                                                <font face="Times New Roman">{{ $penyata->e91_npg }}
                                                                </font>
                                                            </b></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19"><b>
                                                                <font face="Times New Roman">{{ $penyata->e91_jpg }}</font>
                                                            </b></td>
                            ...
                            @endforeach
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="25%" height="19">Nama Pegawai Melapor:
                                            </td>

                                            <td width="88%" height="19"><b>{{ $data->e_npg }}</b></td>

                                        </tr><br><br>

                                        <tr>

                                            <td width="25%" height="19">Jawatan Pegawai Melapor:
                                            </td>

                                            <td width="88%" height="19"><b>{{ $data->e_jpg }}</b></td>

                                        </tr><br><br>

                                        <tr>

                                            <td width="25%" height="19">No Telefon Kilang: </td>

                                            <td width="88%" height="19"><b>{{ $data->e_notel }}</b></td>
