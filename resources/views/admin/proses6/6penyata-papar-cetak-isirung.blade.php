    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="tab" style="margin-left:2%">
                ...
                Terkini</button> --}}
                <a style="color:black; border-radius:unset; font-size:12px; background-color:rgb(253, 255, 255)"
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-3">
                            ...
                            <div class=" text-center">
                                ...
                                <h3 style="color: rgb(39, 80, 71); margin-bottom:1%">Penyata Bulanan Isirung - MPOB(EL) CF 4<br> </h3>
                                <h5 style="color: rgb(39, 80, 71); ">Senarai Penyata Yang Telah Dihantar Untuk Paparan dan Cetakan</h5>
                                <div id="title">
                                    <div class="noScreenPelesen">Senarai Penyata Bulanan Isirung - MPOB(EL) CF 4 Yang Telah Dihantar Untuk Paparan dan Cetakan</div>
                            ...
                            <section class="section">
                                <div class="card">
                                    ...
                                    <form action="{{ route('admin.6papar.isirung.form') }}" id="tickform" method="post">
                                        @csrf
