                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-3">
                            ...
                            <div class=" text-center">
                                ...
                                <div id="title">
                                <div class="noScreenPelesen">Senarai Penyata Bulanan Kilang Buah - MPOB(EL) MF 4 Yang Telah Dihantar Untuk Paparan dan Cetakan</div>
                            ...
                            <section class="section">
                                <div class="card">
                                    ...
                                    <form action="{{ route('admin.6papar.buah.form') }}" id="tickform" method="post">
                                        @csrf
