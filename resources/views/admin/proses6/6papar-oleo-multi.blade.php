                                            ...
                                            <body>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19"><b>
                                                                <font face="Times New Roman">{{ $data->e104_npg }}
                                                                </font>
                                                            </b></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19"><b>
                                                                <font face="Times New Roman">{{ $data->e104_jpg }}</font>
                                                            </b></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19"><b>
                                                                <font face="Times New Roman">{{ $data->e104_notel }}</font>
                                                            </b></td>
                            ...
                            @endforeach
                                                ...
                                                <div class="row form-group" style="padding-top: 10px; ">
                                                    ...
                                                    <div class="text-left col-md-5">
                                                        <a href="{{ route('admin.6penyatapaparcetakoleo') }}" class="btn btn-primary"
