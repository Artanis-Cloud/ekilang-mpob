    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="tab" style="margin-left:2%">
                ...
                <a href="{{ route('admin.5penyatabelumhantarsimpanan') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-3">
                            ...
                            <div class=" text-center">
                                ...
                                <div id="title">
                                    <div class="noScreenPelesen">Senarai Penyata Bulanan Pusat Simpanan - MPOB(EL) KS 4 Yang Telah Dihantar Untuk Paparan dan Cetakan</div>
                            ...
                            <section class="section">
                                <div class="card">
                                    ...
                                    <br>
                                    <form action="{{ route('admin.6papar.simpanan.form') }}" id="tickform" method="post">
                                        @csrf
