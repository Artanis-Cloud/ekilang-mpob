                                ...
                                <div class="pl-3">
                                    ...
                                    <div class="container center mt-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="status_ekilang">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="e_stock">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="directory">
                                        ...
                                        <div class=" text-center mt-2">
                                            <h4 style="color: rgb(39, 80, 71); margin-bottom:1%">Pertukaran No Lesen Lama Ke
                                                No Lesen Baru</h4>
                                        </div>
                                        <hr>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="status_emingguan">
                                                        <option selected hidden disabled>Sila Pilih</option>
                                                        <option value="1">Aktif</option>
                                                        <option value="2">Tidak Aktif</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="status_direktori">
                                                        <option selected hidden disabled>Sila Pilih</option>
                                                        <option value="Y">Ya</option>
                                                        <option value="N">Tidak</option>
                                                    </select>
                                    ...
                                    <div class="row form-group" style="padding-top: 20px; ">
                                        ...
                                        <div class="text-right col-md-12 mb-4 ">
                                            <button type="submit" class="btn btn-primary " data-toggle="modal"
                                                style="float: right" data-target="#confirmation">Tukar No Lesen</button>
                                        </div>
