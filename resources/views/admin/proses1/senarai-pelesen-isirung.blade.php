                    ...
                    <div class="pl-3">
                        ...
                        <div class=" text-center">
                            <div id="title">
                                ...
                                <h5 style="color: rgb(39, 80, 71); ">KILANG ISIRUNG</h5>
...
<script>
    $('#exportExcel').on('click', function(){
      ...
      saveAs(new Blob([s2ab(wbout)], {type:"application/octet-stream"}), 'Senarai Pelesen Berdaftar Kilang Isirung.xlsx');
    })
  </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // DataTable
            var table = $('#example102').DataTable({
                ...
                buttons: [
                    ...
                    'pageLength',
                    {
                        ...
                        filename: 'Senarai Pelesen Kilang Isirung',
