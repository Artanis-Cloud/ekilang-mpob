        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="card">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">QML 1</h3>
                ...
                <div class="col-sm-2">
                    <div class="card">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">QML 2</h3>
                ...
                <div class="col-sm-2">
                    <div class="card">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">QML 3</h3>
                ...
                <div class="col-sm-2">
                    <div class="card">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">QML 4</h3>
                ...
                <div class="col-sm-2">
                    <div class="card">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">QML 5</h3>
                ...
                <div class="col-sm-2">
                    <div class="card">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">QML 6</h3>
                ...
                <div class="col-sm-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <button type="button" class="btn btn-primary"  style="margin-top: -10px" data-toggle="modal"
                                onclick="window.location='{{ URL::route('admin.laporan.bulanan'); }}'"
                                    >Cari</button>
                            </div>
                        </div>
                    </div>
