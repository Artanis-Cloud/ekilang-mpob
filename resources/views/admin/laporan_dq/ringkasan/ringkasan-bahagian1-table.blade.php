                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if ($result)
                                                                        ...
                                                                        @foreach ($ebio_b5_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b5 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d" >
                                                                    ...
                                                                    @for ($i = 1; $i <= 12; $i++)
                                                                        ...
                                                                        <td class="text-center;" style= "mso-number-format:'#,##0.00'">
                                                                            <b>{{ number_format($total_col_bulan_b5[$i] ?? 0,2) }}</b>
                                                                        </td>
                                                                        @php
                                                                    ...
                                                                    @endfor
                                                                    <td class="text-center;"  style= "mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b5 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @elseif ($bulan == 'equal')
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th style="text-align: center; mso-number-format:'#,##0.00'" colspan="6">
                                                                        <b>Jumlah</b>
                                                                    </th>
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b5 ?? 0,2) }}</b>
                                                                    </td>
                                                                </tr>
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                ...
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{-- @endif --}}
                                                                                    @php
                                                                                        $jumlah5 += $ebio_b5_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        $jumlah_bulan5[$i] += $ebio_b5_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                    @endphp
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b5 ?? 0,2) }}</b>
                                                                    </td>
                                                        ...
                                                        @if ($result)
                                                            ...
                                                            @if ($bulan == null)
                                                                        ...
                                                                        @foreach ($ebio_b6_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                @for ($i=1; $i<=12;$i++)
                                                                                    ...
                                                                                    @php
                                                                                        $jumlah_b6 += $ebio_b6_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        $total_col_bulan_b6[$i] += $ebio_b6_bhg1[$data->e_nl][$kodProduk][$i] ?? 0  ;
                                                                                    @endphp
                                                                                @endfor

                                                                                <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b6 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_col_bulan_b6[$i] ?? 0,2) }}</b>
                                                                    </td>
                                                                    @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b6 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @elseif ($bulan == 'equal')
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th class="text-right" colspan="6"><b>Jumlah</b></th>
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b6 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{--@endif --}}
                                                                                        @php
                                                                                            $jumlah6 += $ebio_b6_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                            $jumlah_bulan6[$i] += $ebio_b6_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        @endphp
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b6 ?? 0,2) }}</b>
                                                                    </td>
                                                        ...
                                                        @if ($result)
                                                            ...
                                                            @if ($bulan == null)
                                                                        ...
                                                                        @foreach ($ebio_b7_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                @for ($i=1; $i<=12;$i++)
                                                                                    ...
                                                                                    @php
                                                                                        $jumlah_b7 += $ebio_b7_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        $total_col_bulan_b7[$i] += $ebio_b7_bhg1[$data->e_nl][$kodProduk][$i] ?? 0  ;
                                                                                    @endphp
                                                                                @endfor

                                                                                <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b7 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d" >
                                                                    ...
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_col_bulan_b7[$i] ?? 0,2) }}</b>
                                                                    </td>
                                                                    @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b7 ?? 0,2) }}</b>
                                                                    </td>
                                                                </tr>
                                                            @elseif ($bulan == 'equal')
                                                                @php
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th class="text-right" colspan="6"><b>Jumlah</b></th>
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b7 ?? 0,2) }}</b></td>
                                                            ...
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{--@endif --}}
                                                                                        @php
                                                                                            $jumlah7 += $ebio_b7_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                            $jumlah_bulan7[$i] += $ebio_b7_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        @endphp
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b7 ?? 0,2) }}</b>
                                                                    </td>
                                                        ...
                                                        @if ($result)
                                                            ...
                                                            @if ($bulan == null)
                                                                        ...
                                                                        @foreach ($ebio_b8_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                @for ($i=1; $i<=12;$i++)
                                                                                    ...
                                                                                    @php
                                                                                        $jumlah_b8 += $ebio_b8_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        $total_col_bulan_b8[$i] += $ebio_b8_bhg1[$data->e_nl][$kodProduk][$i] ?? 0  ;
                                                                                    @endphp
                                                                                @endfor

                                                                                <td cstyle="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b8 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d" >
                                                                    ...
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_col_bulan_b8[$i] ?? 0,2) }}</b>
                                                                    </td>
                                                                    @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b8 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @elseif ($bulan == 'equal')
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th class="text-right" colspan="6"><b>Jumlah</b></th>
                                                                    <td  style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b8 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{--@endif --}}
                                                                                        @php
                                                                                            $jumlah8 += $ebio_b8_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                            $jumlah_bulan8[$i] += $ebio_b8_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        @endphp


                                                                                @endfor
                                                                            <td style="text-center; mso-number-format:'#,##0.00'">
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b8 ?? 0,2) }}</b>
                                                                    </td>
                                                        ...
                                                        @if ($result)
                                                            ...
                                                            @if ($bulan == null)
                                                                        ...
                                                                        @foreach ($ebio_b9_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                @for ($i=1; $i<=12;$i++)
                                                                                    ...
                                                                                    @php
                                                                                        $jumlah_b9 += $ebio_b9_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        $total_col_bulan_b9[$i] += $ebio_b9_bhg1[$data->e_nl][$kodProduk][$i] ?? 0  ;
                                                                                    @endphp
                                                                                @endfor

                                                                                <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b9 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d" >
                                                                    ...
                                                                    @for ($i = 1; $i <= 12; $i++)
                                                                        ...
                                                                        <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                            <b>{{ number_format($total_col_bulan_b9[$i] ?? 0,2) }}</b>
                                                                        </td>
                                                                        @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b9 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @elseif ($bulan == 'equal')
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th class="text-right" colspan="6"><b>Jumlah</b></th>
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b9 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{--@endif --}}
                                                                                        @php
                                                                                            $jumlah9 += $ebio_b9_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                            $jumlah_bulan9[$i] += $ebio_b9_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        @endphp
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b9 ?? 0,2) }}</b>
                                                                    </td>
                                                        ...
                                                        @if ($result)
                                                            ...
                                                            @if ($bulan == null)
                                                                        ...
                                                                        @foreach ($ebio_b10_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                @for ($i=1; $i<=12;$i++)
                                                                                    ...
                                                                                    @php
                                                                                        $jumlah_b10 += $ebio_b10_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        $total_col_bulan_b10[$i] += $ebio_b10_bhg1[$data->e_nl][$kodProduk][$i] ?? 0  ;
                                                                                    @endphp
                                                                                @endfor

                                                                                <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b10 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d" >
                                                                    ...
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_col_bulan_b10[$i] ?? 0,2) }}</b>
                                                                    </td>
                                                                    @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b10 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @elseif ($bulan == 'equal')
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th class="text-right" colspan="6"><b>Jumlah</b></th>
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b10 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{--@endif --}}
                                                                                        @php
                                                                                            $jumlah10 += $ebio_b10_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                            $jumlah_bulan10[$i] += $ebio_b10_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        @endphp
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b10 ?? 0,2) }}</b>
                                                                    </td>
                                                        ...
                                                        @if ($result)
                                                            ...
                                                            @if ($bulan == null)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($ebio_b11_bhg1[$data->e_nl] as $kodProduk => $test)
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                                    <b>{{ number_format($jumlah_b11 ?? 0,2)}}</b>
                                                                                </td>
                                                                ...
                                                                <tr style="background-color: #d3d3d34d" >
                                                                    ...
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_col_bulan_b11[$i] ?? 0,2) }}</b>
                                                                    </td>
                                                                    @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_all_bulan_b11 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @elseif ($bulan == 'equal')
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    <th class="text-right" colspan="6"><b>Jumlah</b></th>
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($total_bulan_b11 ?? 0,2) }}</b>
                                                                    </td>
                                                            ...
                                                            @else
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endphp
                                                                                @for ($i = $start_month; $i <= $end_month; $i++)
                                                                                    ...
                                                                                    {{--@endif --}}
                                                                                        @php
                                                                                            $jumlah11 += $ebio_b11_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                            $jumlah_bulan11[$i] += $ebio_b11_bhg1[$data->e_nl][$kodProduk][$i] ?? 0;
                                                                                        @endphp
                                                                ...
                                                                <tr style="background-color: #d3d3d34d">
                                                                    ...
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format($jumlah_bulan11[$i] ?? 0,2) }}</b></td>
                                                                    @php
                                                                    ...
                                                                    @endfor
                                                                    <td style="text-align: center; mso-number-format:'#,##0.00'">
                                                                        <b>{{ number_format( $total_between_bulan_b11 ?? 0,2) }}</b>
                                                                    </td>
