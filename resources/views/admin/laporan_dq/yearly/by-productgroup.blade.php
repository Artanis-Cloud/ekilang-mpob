        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="card card-hover" onclick="window.location='{{ URL::route('admin.laporan.bulanan') }}'">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%;">OYG 1</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 2</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 3</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 4</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 5</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 6</h3>
                                <hr>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="card card-hover" onclick="window.location='{{ URL::route('admin.laporan.bulanan') }}'">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 7</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 8</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 9</h3>
                                <hr>
                ...
                <div class="col-sm-2">
                    <div class="card card-hover">
                        <div class=" text-center">
                            <h5 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OYG 10</h3>
                                <hr>
