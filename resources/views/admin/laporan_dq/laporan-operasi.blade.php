                                            ...
                                            @if ($bulan == null)
                                                ...
                                                @foreach ($kap as $key => $data)
                                                    <tr>
                                                        ...
                                                        <td>{{ $lesen[$key]}}</td>
                                                        <td style="text-align: right">{{ number_format($val_kap[$key] ?? 0,2)}} </td>
                                                        @if ($negeri[$key] == '01')
                                                ...
                                                <tr style="background-color: #d3d3d34d" >
                                                    ...
                                                    <td class="font-weight-bold text-center">{{ number_format( $total_col_bulan_c4[$i]?? 0,2) }}</td>
