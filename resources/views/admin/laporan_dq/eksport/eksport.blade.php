        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-5 align-self-center">
                    <h4 class="page-title">Oleokimia - Eksport
                    </h4>
                </div>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        <div class=" text-center">
                            <h3 style="color: rgb(39, 80, 71); margin-top:3%; margin-bottom:1%">OCA9::OLEOKIMIA</h3>
                            <h5 style="color: rgb(39, 80, 71); margin-bottom:1%">Eksport Mengikut Pelesen</h5>
                        </div>
                        <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mr-auto">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="username" onchange="ajax_pelesen(this)">
                                                <option selected hidden disabled>Sila Pilih</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="e_kat">
                                                ...
                                                @foreach ($negara as $negaras)
                                                    <option value="">{{ $negaras->namanegara }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
