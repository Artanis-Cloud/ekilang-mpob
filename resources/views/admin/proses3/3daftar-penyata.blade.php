            ...
            <div class="mt-1 mb-4 row">
                <div class="col-md-12">
                    ...
                    <div class="tab" style="margin-right:10%; margin-left:10%">
                        <button class="tablinks" onclick="openInit(event, 'All')" id="defaultOpen">Initialize
                            Semua Pelesen</button>
                        <button class="tablinks" onclick="openInit(event, 'One')">Initialize Satu Pelesen</button>
