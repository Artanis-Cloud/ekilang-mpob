...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <nav class="navbar navbar-header navbar-expand navbar-light" style="margin-bottom: 2%; background:transparent">
                ...
                <a class="navbar-brand">
                    ...
                    <img src="{{ asset('/mpob.png') }}" height='60px' width='70px' alt=""
                        style="margin-left: 20%; margin-right:2%; margin-top: 15px;">
                    <img src="{{ asset('/mspo.png') }}" height='76px' width='65px' alt=""
                        style="margin-top: 20px; margin-right:10%; margin-left:2%;">
                </a>
            ...
            <section id="hero" class="d-flex align-items-center ">
                <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-9 text-center" style="margin-top: -10%">
                    ...
                    <div class="container" data-aos="fade-up">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 pt-3 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                                ...
                                <ul>
                                    <li><i class="bx bx-check-double"></i> Ullamco laboris nisi ut aliquip ex ea
                                        commodo consequat.</li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center"
                                data-aos="zoom-in">
                                <img src="{{ asset('theme/kilangstyles/img/clients/client-1.png') }}" class="img-fluid" alt="">
                            </div>
                            ...
                            <ul>
                                <li data-aos="fade-up">
                                    <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                                        class="collapse" data-bs-target="#faq-list-1">Non consectetur a erat nam
                                ...
                                <li data-aos="fade-up" data-aos-delay="300">
                                    <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                                        data-bs-target="#faq-list-4" class="collapsed">Tempus quam pellentesque
