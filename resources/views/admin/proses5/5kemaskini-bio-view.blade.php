                            ...
                            <body>
                                ...
                                <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penyataia as $penyataia2)
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.exe.a', [$penyataia2->ebio_b1]) }}"
                                        ...
                                        @endforeach
                                        <tr>
                                            <form action="{{ route('admin.add.bahagian.ia', [$penyata->ebio_reg]) }}"
                                                method="post" id="add">
                                                @csrf
                                                <td align="left">
                                ...
                                <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penyataib as $penyataib2)
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.exe.b', [$penyataib2->ebio_b1]) }}"
                                        ...
                                        @endforeach
                                        <tr>
                                            <form action="{{ route('admin.add.bahagian.ib', [$penyata->ebio_reg]) }}"
                                                method="post" id="add2">
                                                @csrf
                                                <td align="left">
                                                    <select class="form-control select2" id="ebio_b4" name="ebio_b4"
                                ...
                                <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penyataic as $key => $penyataic2)
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.exe.c', [$penyataic2->ebio_b1]) }}"
                                        ...
                                        <tr>
                                            <form
                                                action="{{ route('admin.add.bahagian.ic', [$penyata->ebio_reg ?? 0]) }}"
                                                method="post" id="add3">
                                                @csrf
                                                <td align="left">
                                                    <select class="form-control select2" id="ebio_b4" name="ebio_b4"
                                ...
                                <table border="0" width="50%" cellspacing="0" cellpadding="0">
                                    ...
                                    @else
                                        <tbody>
                                            <form
                                                action="{{ route('admin.add.maklumat.bio.ii', [$penyata->ebio_nl]) }}"
                                ...
                                @if ($penyataiii && !$penyataiii->isEmpty())
                                    ...
                                    <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($penyataiii as $penyataiii2)
                                                <form
                                                    action="{{ route('admin.kemaskini.maklumat.bio.exe.iii', [$penyataiii2->ebio_c1]) }}"
                                                        ...
                                                        @if ($penyataiii2->produk->prodid == 'AW')
                                                            <td align="right" id="data_hidden2">
                                                                <input type="text" name='ebio_c8'
                                                                    ...
                                                                    readonly>
                                                                <a
                                                                    href="{{ route('admin.view.bahagian.iii.sykt', $penyataiii2->ebio_c1) }}">
                                            ...
                                            <form
                                                action="{{ route('admin.add.bahagian.iiikini', [$penyata->ebio_reg]) }}"
                                                method="post" id="subs5" class="sub-form">
                                                @csrf
                                                {{-- <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                                                        class="table table-bordered" style="padding: 0.2rem 0.3rem">
                                                                        <tbody> --}}
                                    ...
                                    <div id="aw_container" style="display: none">
                                        ...
                                        <form action="{{ route('admin.add.bahagian.iiikini', [$penyata->ebio_reg]) }}"
                                            method="post" id="add16" class="sub-form">
                                            @csrf
                                            <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                @else
                                    <form action="{{ route('admin.add.bahagian.iiikini', [$penyata->ebio_reg]) }}"
                                        method="post" id="add15" class="sub-form">
                                        @csrf
                                        <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                            id="main" class="table table-bordered"
                                            style="padding: 0.2rem 0.3rem">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name='ebio_c4' style="text-align: right"
                                                            id="ebio_c4" class="form-control"
                                                            onkeypress="return isNumberKey(event)">
                                                    </td>
                                                    <td>
                                                        <input type="text" name='ebio_c5' style="text-align: right"
                                                            id="ebio_c5" class="form-control"
                                                            onkeypress="return isNumberKey(event)">
                                                    </td>
                                                    <td>
                                                        <input type="text" name='ebio_c6' style="text-align: right"
                                                            id="ebio_c6" class="form-control"
                                                            onkeypress="return isNumberKey(event)">
                                                    </td>
                                                    <td>
                                                        <input type="text" name='ebio_c7' style="text-align: right"
                                                            id="ebio_c7" class="form-control"
                                                            onkeypress="return isNumberKey(event)">
                                                    </td>
                                                    <td id="data_hidden">
                                                        <input type="text" name='ebio_c8' id="ebio_c8"
                                            ...
                                            <td class="field">
                                                <div id="sykt1">
                                                    <select class="form-control " style="width: 100%"
                                                        ...
                                                        <option id="def" selected='selected' value="0">Sila
                                                            Pilih
                                                        </option>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="size: 10ch" class="actions2" align="center">
                                            <i class="fa fa-plus-circle center" type="button" id="tambah_maklumat2"
                                                onclick="add_row_new()" disabled="disabled"
                                                style="font-size:30px; color:green;">
                                                {{-- <input  class="btn btn-primary ml-1 actions"
                                                id="tambah_maklumat" onclick="add_row()" disabled="disabled"
                                                value="Tambah Maklumat"> --}}
