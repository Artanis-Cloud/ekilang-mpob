                ...
                <div class="page-breadcrumb" style="padding: 0px">
                    <div class="pb-2 row">
                        <div class="col-5 align-self-center">
                            <h4 class="page-title" style="padding: 10px">Penyata Bulanan Belum Hantar Kilang Oleokimia
                                (Biodiesel)</h4>
                        </div>
                                            ...
                                            <table border="0" width="100%">
                                                <tbody style="float: right; width:10rem; margin-right: -10px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19">
                                                            <p align="left" style="margin-top: -15px"><b>MPOB(EL) PX 4-CM
                                                                </b></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="88%" height="19">
                                                            <p align="left" style="margin-top: -15px"><b>MPOB(EL) PM 4-CM
                                                                </b></p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    @if ($penyataia[$key] && !$penyataia[$key]->isEmpty())
                                                        ...
                                                        @foreach ($penyataia[$key] as $dataia)
                                                            <tr>
                                                                ...
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b5 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b6 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b7 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b8 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b9 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b10 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                <td align="right">
                                                                    <font size="2">
                                                                ...
                                                                <td align="right">
                                                                    <font size="2">
                                                                        {{ number_format($dataia->ebio_b11 ?? 0, 2) }}
                                                                    </font>
                                                                </td>
                                                                @php
                                        ...
                                        <table border="0" width="50%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="100"><b>:{{ $penyataii[$key]->hari_operasi ?? '' }}
                                                            Hari</b></td>
                                                </tr>
                                                <tr>
                                                    <td width="380">Kadar Penggunaan Kapasiti Sebulan</td>
                                                    <td width="100"><b>:{{ $penyataii[$key]->kapasiti ?? '' }} %</b>
                                                    </td>
                                                </tr>
