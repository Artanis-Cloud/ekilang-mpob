...
@section('content')
                            ...
                            <body>
                                ...
                                <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penyataia as $penyataia2)
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.exe.a.dahulu', [$penyataia2->ebio_b1]) }}"
                                                class="sub-form" method="post" id="form1">
                                                @csrf
                                                <tr>
                                                    <td align="left">
                                                        <select class="form-control" id="ebio_b4" name="ebio_b4"
                                                            onchange="ajax_produk(this);">
                                                            <option selected value="">Sila Pilih Kumpulan Produk
                                                            </option>
                                                            @foreach ($produk as $prods)
                                                                <option value="{{ $prods->prodid }}"
                                                                    {{ old('ebio_b4', $penyataia2->produk->prodid) == $prods->prodid ? 'selected' : '' }}>
                                                    ...
                                                    <td>
                                                        <div class="icon" style="text-align: center">
                                                            ...
                                                            <button type="submit" class="btn"
                                                                style="background-color: rgba(196, 67, 67, 0)">
                                                                <i class="fa fa-edit"
                                                                    style="color: #2fb851;font-size:18px"></i>
                                                            </button>
                                        ...
                                        <tr>
                                            <form
                                                action="{{ route('admin.add.bahagian.ia.dahulu', [$penyata->ebio_nobatch]) }}"
                                                method="post" id="add">
                                                @csrf
                                                <td align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b5 ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b6 ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b7 ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b8 ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b9 ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b10 ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b11 ?? 0, 2) }}</b>
                                            </td>
                                            {{-- <td colspan="2">-</td> --}}
                                        </tr>
                                ...
                                <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penyataib as $penyataib2)
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.exe.b.dahulu', [$penyataib2->ebio_b1]) }}"
                                                class="sub-form" method="post" id="form2">
                                                @csrf
                                                    ...
                                                    <td align="left">
                                                        <select class="form-control" id="ebio_b4" name="ebio_b4"
                                                            ...
                                                            @foreach ($produk_b as $prods)
                                                                <option value="{{ $prods->prodid }}"
                                                                    {{ old('ebio_b4', $penyataib2->produk->prodid) == $prods->prodid ? 'selected' : '' }}>
                                                                    {{ $prods->proddesc }} - {{ $prods->prodid }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <tr>
                                            <form
                                                action="{{ route('admin.add.bahagian.ib.dahulu', [$penyata->ebio_nobatch]) }}"
                                                method="post" id="add2">
                                                @csrf
                                                <td align="left">
                                                    <select class="form-control select2" id="ebio_b4" name="ebio_b4"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b5_b ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b6_b ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b7_b ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b8_b ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right"><b>{{ number_format($total_col_ebio_b9_b ?? 0, 2) }}</b>
                                            </td>
                                            <td class="text-right">
                                                <b>{{ number_format($total_col_ebio_b10_b ?? 0, 2) }}</b></td>
                                            <td class="text-right">
                                                <b>{{ number_format($total_col_ebio_b11_b ?? 0, 2) }}</b></td>
                                            {{-- <td colspan="2">-</td> --}}
                                        </tr>
                                        {{-- @else
                                                    <tr>
                                ...
                                <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penyataic as $key => $penyataic2)
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.exe.c.dahulu', [$penyataic2->ebio_b1]) }}"
                                                class="sub-form" method="post" id="form3">
                                                @csrf
                                                    ...
                                                    <td align="left">
                                                        <select class="form-control" id="ebio_b4" name="ebio_b4"
                                                            ...
                                                            @foreach ($produk_c as $prods)
                                                                <option value="{{ $prods->prodid }}"
                                                                    {{ old('ebio_b4', $penyataic2->produk->prodid) == $prods->prodid ? 'selected' : '' }}>
                                                                    {{ $prods->proddesc }} - {{ $prods->prodid }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <tr>
                                            <form
                                                action="{{ route('admin.add.bahagian.ic.dahulu', [$penyata->ebio_nobatch ?? 0]) }}"
                                                method="post" id="add3">
                                                @csrf
                                                <td align="left">
                                                    <select class="form-control select2" id="ebio_b4" name="ebio_b4"
                                ...
                                <table border="0" width="50%" cellspacing="0" cellpadding="0">
                                    @if ($penyataii)
                                        <tbody>
                                            <form
                                                action="{{ route('admin.kemaskini.maklumat.bio.ii.dahulu', [$penyataii->lesen]) }}"
                                                class="sub-form" method="post" id="formii">
                                                @csrf
                                                <tr>
                                                    <td width="50%">Jumlah Hari Kilang Beroperasi Sebulan :</td>
                                                    <td width="20%" align="left">
                                                        <input type="text" name='hari_operasi'
                                                            style="text-align: right" id='hari_operasi'
                                                            class="form-control" onkeypress="return isNumberKey(event)"
                                                            oninput="FormatCurrency(this);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" align="left">
                                                        <input type="text" name='kapasiti' style="text-align: right"
                                                            id='kapasiti' class="form-control"
                                                            onkeypress="return isNumberKey(event)"
                                                            oninput="FormatCurrency(this);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" align="left">
                                                        <div class="icon" style="text-align: center">
                                                            ...
                                                            <button class="dt-button buttons-excel buttons-html5 mt-1"
                                                                type="submit"
                                                                style="background-color: white; color: #0a7569; ">
                                                                <i class="fa fa-edit" style="color: #0a7569"></i>
                                                                Kemaskini
                                                            </button>
                                    ...
                                    @else
                                        <tbody>
                                            <form
                                                action="{{ route('admin.add.maklumat.bio.ii.dahulu', [$penyata->ebio_nl]) }}"
                                                class="sub-form" method="post" id="formAddii">
                                                @csrf
                                                <tr>
                                                    <td width="50%">Jumlah Hari Kilang Beroperasi Sebulan :</td>
                                                    <td width="20%" align="left">
                                ...
                                @if ($penyataiii && !$penyataiii->isEmpty())
                                    ...
                                    <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($penyataiii as $penyataiii2)
                                                <form
                                                    action="{{ route('admin.kemaskini.maklumat.bio.exe.iii.dahulu', [$penyataiii2->ebio_c1]) }}"
                                                    class="sub-form" method="post" id="form4">
                                                    @csrf
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <select class="form-control" id="ebio_c3" name="ebio_c3"
                                                                ...
                                                                @foreach ($produkiii as $prods)
                                                                    <option value="{{ $prods->prodid }}"
                                                                        {{ old('ebio_c3', $penyataiii2->produk->prodid) == $prods->prodid ? 'selected' : '' }}>
                                                                        {{ $prods->proddesc }} - {{ $prods->prodid }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <td align="right">
                                                            <input type="text" name='ebio_c4'
                                                                style="text-align: right" id='ebio_c4'
                                                                class="form-control"
                                                                onkeypress="return isNumberKey(event)"
                                                                oninput="FormatCurrency(this);"
                                                        ...
                                                        <td align="right">
                                                            <input type="text" name='ebio_c5'
                                                                style="text-align: right" id='ebio_c5'
                                                                class="form-control"
                                                                onkeypress="return isNumberKey(event)"
                                                                oninput="FormatCurrency(this);"
                                                        ...
                                                        <td align="right">
                                                            <input type="text" name='ebio_c6'
                                                                style="text-align: right" id='ebio_c6'
                                                                class="form-control"
                                                                onkeypress="return isNumberKey(event)"
                                                                oninput="FormatCurrency(this);"
                                                        ...
                                                        <td align="right">
                                                            <input type="text" name='ebio_c7'
                                                                style="text-align: right" id='ebio_cb7'
                                                                class="form-control"
                                                                onkeypress="return isNumberKey(event)"
                                                                oninput="FormatCurrency(this);"
                                                        ...
                                                        @if ($penyataiii2->produk->prodid == 'AW')
                                                            <td align="right" id="data_hidden2">
                                                                <input type="text" name='ebio_c8'
                                                                    style="text-align: right" id='ebio_c8_2'
                                                                    class="form-control"
                                                                    onkeypress="return isNumberKey(event)"
                                                                    oninput="FormatCurrency(this);"
                                                                    ...
                                                                    readonly>
                                                                <a
                                                                    href="{{ route('admin.view.bahagian.iii.sykt.dahulu', $penyataiii2->ebio_c1) }}">
                                                        ...
                                                        @else
                                                            <td align="right">
                                                                <input type="text" name='ebio_c8'
                                                                    style="text-align: right" id='ebio_c8'
                                                                    class="form-control"
                                                                    onkeypress="return isNumberKey(event)"
                                                                    oninput="FormatCurrency(this);"
                                                                    value="{{ number_format($penyataiii2->ebio_c8 ?? 0, 2) }}">
                                                        ...
                                                        <td align="right">
                                                            <input type="text" name='ebio_c9'
                                                                style="text-align: right" id='ebio_c9'
                                                                class="form-control"
                                                                onkeypress="return isNumberKey(event)"
                                                                oninput="FormatCurrency(this);"
                                                        ...
                                                        <td align="right">
                                                            <input type="text" name='ebio_c10'
                                                                style="text-align: right" id='ebio_c10'
                                                                class="form-control"
                                                                onkeypress="return isNumberKey(event)"
                                                                oninput="FormatCurrency(this);"
                                                ...
                                                <div class="modal fade" id="next4{{ $penyataiii2->ebio_c1 }}"
                                            ...
                                            <form
                                                action="{{ route('admin.add.bahagian.iii.dahulu', [$penyata->ebio_nobatch]) }}"
                                                method="post" id="subs5">
                                                @csrf
                                                {{-- <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                                                        class="table table-bordered" style="padding: 0.2rem 0.3rem">
                                                                        <tbody> --}}
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <select class="form-control select2" id="produk24"
                                                            name="ebio_c3">
                                                            <option selected value="">Sila Pilih Kumpulan Produk
                                                            </option>
                                                    ...
                                                    <td id="data_hidden">
                                                        <input type="text" name='ebio_c8' id="ebio_c8"
                                    ...
                                    @if ($penyataiii2->produk->prodid != 'AW')
                                        <div class="" id="aw">
                                            <a onclick="showAW()"
                                                ...
                                                &nbsp;> (Sila Klik Disini untuk mengisi bagi Produk: PALM DIESEL / BIODIESEL
                                                / METHYL ESTER - AW) </a>
                                        </div>
                                    @endif
                                    ...
                                    <div id="aw_container" style="display: none">
                                        ...
                                        <form
                                            action="{{ route('admin.add.bahagian.iii.dahulu', [$penyata->ebio_nobatch]) }}"
                                            method="post" id="add16">
                                            @csrf
                                            <table border="1" width="100%" cellspacing="0" cellpadding="0"
                                                id="main" class="table table-bordered"
                                                ...
                                                <tbody>
                                                    <tr style="background-color: #d3d3d370">
                                                        ...
                                                        <td width="8%"
                                                            style="text-align: center; vertical-align:middle"><b>
                                                                <font size="2">Digunakan Untuk Proses Selanjutnya
                                                                </font>
                                                            </b></td>
                                                        <td width="8%"
                                                            style="text-align: center; vertical-align:middle"><b>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <select class="form-control select2" id="produk2"
                                                                name="ebio_c3" onchange="showDetail2()">
                                                                <option selected value="">Sila Pilih Kumpulan Produk
                                                                </option>
                                                        ...
                                                        <td id="data_hidden_new">
                                                            <input type="text" name='ebio_c8' id="ebio_c8_new"
                                                                style="text-align: right"
                                                                onchange="autodecimal(this); FormatCurrency(this)"
                                                                onkeypress="return isNumberKey(event)"
                                                                class="form-control">
                                                            <div id="merah_container_new" style="display:none"
                                                                class="blink_me">
                                                                <i class="fa fa-pencil-alt"
                                                                    title="Pengisian maklumat jualan"
                                                                    style="font-size:11px; color:red; font:rubik"
                                                                    type="button" data-toggle="modal"
                                                                    data-target="#modal_new" &nbsp;> (Sila klik untuk
                                                                    mengisi<br> maklumat
                                                                    jualan) </i>
                                                                <table id="cc3_4_new"></table>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <select class="form-control select2" id="produk"
                                                            name="ebio_c3" onchange="showDetail()">
                                                            <option selected value="">Sila Pilih Kumpulan Produk
                                                            </option>
                                                            @foreach ($produkiii as $prods)
                                                                <option value="{{ $prods->prodid }}">
                                ...
                                <p><b>
                                        <font style="font-size: 15px" color="#0c7c85">
                                            BAHAGIAN 4 :&nbsp;&nbsp;&nbsp;&nbsp;EKSPORT PRODUK BIODIESEL DAN LAIN-LAIN
                                            PRODUK SAWIT
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="field"><select class="form-control select2 "
                                                    style="width: 100px" id="new_syarikat[]" name="new_syarikat[]"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="field"><select class="form-control select2 " style="width: 100px"
                                                id="new_syarikat_new[]" name="new_syarikat[]" onchange="showDetail2()"
                                        ...
                                        <td style="size: 10ch" class="actions" align="center">
                                            <i class="fa fa-plus-circle center" type="button"
                                                id="tambah_maklumat_new" onclick="add_row_new()" disabled="disabled"
                                                style="font-size:30px; color:green;">
                                                {{-- <input  class="btn btn-primary ml-1 actions"
                                                id="tambah_maklumat" onclick="add_row()" disabled="disabled"
                                                value="Tambah Maklumat"> --}}
    ...
    <script>
        function add_row() {
            ...
            $('#data_hidden').append('<input type="hidden" name="new_syarikat_hidden[]"  id="new_syarikat_hidden" value="' +
                new_syarikat + '" />');
            $('#data_hidden').append('<input type="hidden" name="jumlah_row_hidden[]"  id="jumlah_row_hidden" value="' +
                new_jumlah + '" />');
    ...
    <script>
        function add_row_new() {
            ...
            var nama_syarikat = document.getElementById("new_syarikat_new[]").options[document.getElementById(
                    "new_syarikat_new[]")
                .selectedIndex].text;
            ...
            $('#data_hidden_new').append(
                '<input type="hidden" name="new_syarikat_hidden[]"  id="new_syarikat_hidden2" value="' + new_syarikat +
                '" />');
            $('#data_hidden_new').append(
                '<input type="hidden" name="jumlah_row_hidden[]"  id="jumlah_row_hidden2" value="' + new_jumlah + '" />'
                );
