...
<head>
    ...
    <link href="{{ asset('theme/kilangstyles/css/isirungstyle.css') }}" rel=" stylesheet">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu " style="margin-left:-5%">
                                ...
                                <li>
                                    <a href="{{ route('isirung.bahagianvi') }}">
                                        <i class="fas fa-archive" style="color:rgb(54, 51, 41) "> </i>
                                        {{-- <i data-feather="file-plus" width="20"></i> --}}
        ...
        <div id="main">
            ...
            <nav class="navbar navbar-header navbar-expand navbar-light">
                ...
                <span class="mx-2 mt-1 mb-1 text-center navbar-brand h1"
                    ...
                    style="font-family: Poppins, sans-serif; font-size:15px; margin-left:10%;">KILANG ISIRUNG</b>
                </span>
