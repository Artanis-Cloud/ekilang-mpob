...
Route::middleware('auth')->group(function () {
    ...
    // Route::post('/tukar-kata-laluan/kemaskini', [App\Http\Controllers\Admin\MenuLainController::class, 'admin_update_password'])->name('admin.tukar-kata-laluan.kemaskini');
