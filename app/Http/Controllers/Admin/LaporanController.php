...
//   dd($syk_bio);
    ...
    public function admin_validasi_stok_akhir_proses(Request $request)
    {
        ...
        $cpo_sabah = DB::select("SELECT p.e_nl, p.e_np, n.nama_negeri as negeri, b.ebio_b5, b.ebio_b6, b.ebio_b7, b.ebio_b8, b.ebio_b9, b.ebio_b10, b.ebio_b11
            FROM pelesen p, negeri n, h_bio_inits h, h_bio_b_s b
            WHERE h.ebio_thn = '$tahun'
            AND h.ebio_bln = '$bulan'
            AND p.e_negeri = '13'
        ...
        $cpo_srwk = DB::select("SELECT p.e_nl, p.e_np, n.nama_negeri as negeri, b.ebio_b5, b.ebio_b6, b.ebio_b7, b.ebio_b8, b.ebio_b9, b.ebio_b10, b.ebio_b11
            FROM pelesen p, negeri n, h_bio_inits h, h_bio_b_s b
            WHERE h.ebio_thn = '$tahun'
            AND h.ebio_bln = '$bulan'
            AND p.e_negeri = '14'
    ...
    public function admin_validasi_stok_akhir_ikut_produk(Request $request)
    {
        ...
        // DB::connection('mysql2')->select("SELECT lesen,e_np as kilang,negeri.nama_negeri as negeri,
        ...
        //      kilang.e_apnegeri = negeri.id_negeri AND
        //      `penyata`.`lesen` = `profile_bulanan`.`no_lesen` AND" . $sqlstmt1 .
        //     "`kilang`.`jenis` <>  'dummy' AND `penyata`.`kuantiti` <>  0 AND
        //       `penyata`.`kod_produk` =`produk`.`nama_produk`
        //       GROUP by lesen");
