...
class Proses4Controller extends Controller
{
    ...
    public function porting_pelesen()
    {
        ...
        $user = User::with('pelesen')->where('username', '508331406000')->get();
        dd($user);
        ...
        foreach($user as $selects){
           foreach ($selects->pelesen as $key => $pelesen) {
            ...
            if ($data_pelesen[$key]) {
                ...
                $e_nl = $data_pelesen[$key]->e_nl;
                $e_kat = $data_pelesen[$key]->e_kat;
                $e_nlkppk = $data_pelesen[$key]->e_nlkppk;
                $e_thn = date('Y');
                $e_bln = '2';
                $e_np = $data_pelesen[$key]->e_np;
                $e_ap1 = $data_pelesen[$key]->e_ap1;
                $e_ap2 = $data_pelesen[$key]->e_ap2;
                $e_ap3 = $data_pelesen[$key]->e_ap3;
                $e_as1 = $data_pelesen[$key]->e_as1;
                $e_as2 = $data_pelesen[$key]->e_as2;
                $e_as3 = $data_pelesen[$key]->e_as3;
                $e_notel = $data_pelesen[$key]->e_notel;
                $e_nofax = $data_pelesen[$key]->e_nofax;
                $e_email = $data_pelesen[$key]->e_email;
                $e_npg = $data_pelesen[$key]->e_npg;
                $e_jpg = $data_pelesen[$key]->e_jpg ;
                $e_notel_pg = $data_pelesen[$key]->e_notel_pg ;
                $e_email_pg = $data_pelesen[$key]->e_email_pg ;
                $kodpgw = $data_pelesen[$key]->kodpgw ;
                $nosiri = $data_pelesen[$key]->nosiri ;
                $e_npgtg = $data_pelesen[$key]->e_npgtg ;
                $e_jpgtg = $data_pelesen[$key]->e_jpgtg ;
                $eqc_npg = $data_pelesen[$key]->eqc_npg ;
                $eqc_jpg = $data_pelesen[$key]->eqc_jpg ;
                $eqc_email = $data_pelesen[$key]->eqc_email ;
                $e_asnegeri = $data_pelesen[$key]->e_asnegeri ;
                $e_asdaerah = $data_pelesen[$key]->e_asdaerah ;
                $e_negeri = $data_pelesen[$key]->e_negeri ;
                $e_daerah = $data_pelesen[$key]->e_daerah ;
                $e_kawasan = $data_pelesen[$key]->e_kawasan ;
                $e_syktinduk = $data_pelesen[$key]->e_syktinduk ;
                $stk_npg = $data_pelesen[$key]->stk_npg ;
                $stk_notel = $data_pelesen[$key]->stk_notel ;
                $stk_nofax = $data_pelesen[$key]->stk_nofax  ;
                $stk_email = $data_pelesen[$key]->stk_email  ;
                $stk_syktinduk = $data_pelesen[$key]->stk_syktinduk ;
                $stk_cpo_kap =  (float)  $data_pelesen[$key]->stk_cpo_kap ;
                $stk_rbdpo_kap = (float) $data_pelesen[$key]->stk_rbdpo_kap ;
                $stk_rbdpl_kap = (float)   $data_pelesen[$key]->stk_rbdpl_kap ;
                $stk_rbdps_kap = (float)   $data_pelesen[$key]->stk_rbdps_kap ;
                $stk_lainppo_kap =  (float)  $data_pelesen[$key]->stk_lainppo_kap ;
                $stk_ppo_kap =  (float)  $data_pelesen[$key]->stk_ppo_kap ;
                $stk_po_kap =  (float)  $data_pelesen[$key]->stk_po_kap ;
                $stk_pfad_kap =  (float)  $data_pelesen[$key]->stk_pfad_kap ;
                $e_group =  $data_pelesen[$key]->e_group ;
                $e_subgroup =  $data_pelesen[$key]->e_subgroup ;
                $e_poma =  $data_pelesen[$key]->e_poma ;
                $e_biogas =  $data_pelesen[$key]->e_biogas ;
                $e_status_biogas =  $data_pelesen[$key]->e_status_biogas ;
                $e_year =  $data_pelesen[$key]->e_year ?? 0;
                $e_cluster =  $data_pelesen[$key]->e_cluster ;
                $e_katkilang =  $data_pelesen[$key]->e_katkilang ;
                $e_status =  $data_pelesen[$key]->e_status ;
                $e_email_pengurus =  $data_pelesen[$key]->e_email_pengurus ;
                $kap_proses =  $data_pelesen[$key]->kap_proses ;
                $kap_tangki =  $data_pelesen[$key]->kap_tangki  ;
                $bil_tangki_cpo =  $data_pelesen[$key]->bil_tangki_cpo ;
                $bil_tangki_ppo =  $data_pelesen[$key]->bil_tangki_ppo  ;
                $bil_tangki_cpko =  $data_pelesen[$key]->bil_tangki_cpko ;
                $bil_tangki_ppko =  $data_pelesen[$key]->bil_tangki_ppko ;
                $bil_tangki_oleo =  $data_pelesen[$key]->bil_tangki_oleo  ;
                $bil_tangki_oleo =  $data_pelesen[$key]->bil_tangki_others ;
                $bil_tangki_jumlah =  $data_pelesen[$key]->bil_tangki_jumlah ;
                $kap_tangki_cpo =  $data_pelesen[$key]->kap_tangki_cpo ;
                $kap_tangki_ppo =  $data_pelesen[$key]->kap_tangki_ppo ;
                $kap_tangki_cpko =  $data_pelesen[$key]->kap_tangki_cpko  ;
                $kap_tangki_ppko =  $data_pelesen[$key]->kap_tangki_ppko  ;
                $kap_tangki_oleo =  $data_pelesen[$key]->kap_tangki_oleo  ;
                $kap_tangki_others =  $data_pelesen[$key]->kap_tangki_others ;
                $kap_tangki_jumlah =  $data_pelesen[$key]->kap_tangki_jumlah  ;
