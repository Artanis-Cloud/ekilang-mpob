    ...
    public function process_admin_pleid_penapis_form($nobatch, $tahun, $bulan)
    {
        ...
        foreach ($nobatch as $key => $nobatch1) {
           ...
           $query[$nobatch1] = DB::select("SELECT p.kodpgw, p.nosiri, e.e101_bln, e.e101_thn, p.e_nl, p.e_np, p.e_ap1, p.e_ap2, e.e101_nobatch,
            ...
            $totalib5[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B5) FROM pl101bp3 e, codedb.commodity_l p where  e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib6[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B6) FROM pl101bp3 e, codedb.commodity_l p where  e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib7[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B7) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib8[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B8) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib9[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B9) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib10[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B10) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib11[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B11) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib12[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B12) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib13[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B13) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
            $totalib14[$nobatch1] = DB::connection('mysql4')->select("SELECT SUM(e.F101B14) FROM pl101bp3 e, codedb.commodity_l p where e.F101B2 = '$nobatch1' and e.F101B3 = '2' and e.F101B4 = p.comm_code_l");
