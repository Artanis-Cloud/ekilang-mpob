...
class Proses1Controller extends Controller
{
    ...
    protected function store_daftar_pelesen(array $data)
    {
        return Pelesen::create([
            ...
            // 'e_as1' => $data['alamat_premis_3'],
            // 'e_as2' => $data['alamat_premis_3'],
            // 'e_as3' => $data['alamat_premis_3'],
            // 'e_notel' => $data['alamat_premis_3'],
            // 'e_nofax' => $data['alamat_premis_3'],
            // 'e_email' => $data['alamat_premis_3'],
            // 'e_npg' => $data['alamat_premis_3'],
            // 'e_jpg' => $data['alamat_premis_3'],
            // 'kodpgw' => $data['alamat_premis_3'],
            // 'nosiri' => $data['alamat_premis_3'],
            // 'e_npgtg' => $data['alamat_premis_3'],
            // 'e_jpgtg' => $data['alamat_premis_3'],
            ...
            // 'e_negeri' => $data['alamat_premis_3'],
            // 'e_daerah' => $data['alamat_premis_3'],
            // 'e_kawasan' => $data['alamat_premis_3'],
            // 'e_syktinduk' => $data['alamat_premis_3'],
            ...
            // 'e_group' => $data['alamat_premis_3'],
            // 'e_subgroup' => $data['alamat_premis_3'],
            // 'e_poma' => $data['alamat_premis_3'],
            // 'e_year' => $data['alamat_premis_3'],
            // 'e_cluster' => $data['alamat_premis_3'],
            // 'e_katkilang' => $data['alamat_premis_3'],
            // 'e_status' => $data['alamat_premis_3'],
            // 'e_email_pengurus' => $data['alamat_premis_3'],
        ]);
    }
