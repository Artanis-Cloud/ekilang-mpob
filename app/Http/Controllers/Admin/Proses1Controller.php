...
class Proses1Controller extends Controller
{
    ...
    protected function store_daftar_pelesen(array $data)
    {
        ...
        return Pelesen::create([
            ...
            'e_kat' => $data['e_kat'],
            'e_ap1' => $data['e_ap1'],
            'e_ap2' => $data['e_ap2'] ?? NULL,
            'e_ap3' => $data['e_ap3'] ?? NULL,
            'e_as1' => $data['e_as1'],
            'e_as2' => $data['e_as2'] ?? NULL,
            'e_as3' => $data['e_as3'] ?? NULL,
            'e_notel' => $data['e_notel'] ?? NULL,
            'e_nofax' => $data['e_nofax'] ?? NULL,
            'e_email' => $data['e_email'] ?? NULL,
            'e_npg' => $data['e_npg'] ?? NULL,
            'e_jpg' => $data['e_jpg'] ?? NULL,
            'e_notel_pg' => $data['e_notel_pg'] ?? NULL,
            'e_email_pg' => $data['e_email_pg'] ?? NULL,
            'kodpgw' => $data['kodpgw'] ?? NULL,
            'nosiri' => $data['nosiri'] ?? NULL,
            'e_npgtg' => $data['e_npgtg'] ?? NULL,
            'e_jpgtg' => $data['e_jpgtg'] ?? NULL,
            'e_negeri' => $data['e_negeri'] ?? NULL,
            'e_daerah' => $data['e_daerah'] ?? NULL,
            'e_kawasan' => $data['e_kawasan'] ?? NULL,
            'e_syktinduk' => $data['e_syktinduk'] ?? NULL,
            'e_group' => $data['e_group'] ?? NULL,
            'e_poma' =>  $data['e_poma'] ?? NULL,
            'e_biogas' =>  $data['e_biogas'] ?? NULL,
            'e_status_biogas' =>  $data['e_status_biogas'] ?? NULL,
            'e_year' => $data['e_year'] ?? NULL,
            'e_email_pengurus' => $data['e_email_pengurus'] ?? NULL,
            'kap_proses' => $data['kap_proses'] ?? NULL,
            'tahun' => date("Y"),
            'bulan' => date("m"),
    ...
    public function admin_cetak_surat($e_id, RegPelesen $reg_pelesen)
    {
        ...
        return view('admin.proses1.admin-cetak-surat', compact(
            'returnArr',
            'layout',
            'pelesen',
            'pelesen2',
