...
class Proses6Controller extends Controller
{
    ...
    public function process_admin_6penyatapaparcetakpenapis_form(Request $request)
    {
        ...
        // dd($pelesens);
        // $data = DB::table('pelesen')->get();
        return view('admin.proses6.6papar-penapis-multi',compact('returnArr' ,'layout', 'tahun', 'bulan', 'pelesens', 'penyata', 'penyatai',
                    'penyataii',
                    'penyataiii',
                    'penyataiva',
                    'penyataivb',
    ...
    public function process_admin_6penyatapaparcetakisirung_form(Request $request)
    {
        ...
        // dd($pelesens);
        // $data = DB::table('pelesen')->get();
        return view('admin.proses6.6papar-isirung-multi',compact('returnArr' ,'layout', 'tahun', 'bulan', 'pelesens', 'penyata', 'penyatai',
                    'penyataii',
                    'penyataiii',
                    'totaliii',
                    'penyataiv',
    ...
    public function process_admin_6penyatapaparcetakoleo_form(Request $request)
    {
        ...
        // dd($pelesens);
        // $data = DB::table('pelesen')->get();
        return view('admin.proses6.6papar-oleo-multi',compact('returnArr' ,'layout', 'tahun', 'bulan', 'pelesens', 'penyata',
        'penyataia',
        'penyataib',
        'penyataic',
        'penyataii',
    ...
    public function process_admin_6penyatapaparcetaksimpanan_form(Request $request)
    {
        ...
        // dd($pelesens);
        // $data = DB::table('pelesen')->get();
        return view('admin.proses6.6papar-simpanan-multi',compact('returnArr' ,'layout', 'tahun', 'bulan', 'pelesens', 'penyata','penyatai',
